...
- [Printer Thumbnail improvement (experimental feature)](/fdm-monster-server-release-1-8-3#printer-thumbnail-improvement-experimental-feature)
- [Print upload bar would get stuck](/fdm-monster-server-release-1-8-3#print-upload-bar-would-get-stuck)
- [Support paths in Printer URLs (like octoprint_deploy)](/fdm-monster-server-release-1-8-3#support-paths-in-printer-urls-like-octoprint_deploy)
- [Http client with builder pattern](/fdm-monster-server-release-1-8-3#http-client-with-builder-pattern)
- [SocketIO messages are not serialized twice](/fdm-monster-server-release-1-8-3#avoid-serializing-socketio-messages-twice)
- [Smaller chores on the repository](/fdm-monster-server-release-1-8-3#smaller-chores-and-fixes)
