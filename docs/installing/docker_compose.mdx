...
As of version 2.2.0, mDNS support is available via a new image. This image can be selected by adding "-mdns" to an of the above tags.
- latest-mdns
- 2.2.0-mdns
- main-mdns
- develop-mdns
...
The mDNS version requires use of docker's macvlan diver and minor changes to docker-compose.yml 
A helper script is available to perform the macvlan bridge creation and create a docker-compose.yml file; [macvlan-setup.sh](./macvlan-setup.sh)
