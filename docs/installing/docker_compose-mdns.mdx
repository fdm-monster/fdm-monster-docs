...
The [macvlan-setup.sh](https://raw.githubusercontent.com/fdm-monster/fdm-monster-scripts/main/docker/macvlan-setup.sh) can create the required macvlan network and a functional docker-compose.yml (uses tag latest-mdns)
