...
|---------------------------------|----------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------|
| Raspberry Pi                    | [Raspberry Pi 3B+](https://www.raspberrypi.com/products/raspberry-pi-3-model-b/)       | [Raspberry Pi 4B+](https://www.raspberrypi.com/products/raspberry-pi-4-model-b/)         | [Raspberry Pi 5](https://www.raspberrypi.com/products/raspberry-pi-5/)           |
| Raspberry Pi Case               | [Raspberry Pi 3 Case](https://www.raspberrypi.com/products/raspberry-pi-3-case/)       | [Raspberry Pi 4 Case](https://www.raspberrypi.com/products/raspberry-pi-4-case/)         | [Raspberry Pi 5 Case](https://www.raspberrypi.com/products/raspberry-pi-5-case/) |
| Cooling                         | Not Required                                                                           | [Raspberry Pi 4 Case Fan](https://www.raspberrypi.com/products/raspberry-pi-4-case-fan/) | [Active Cooler](https://www.raspberrypi.com/products/active-cooler/)             |
| Power Supply                    | [Micro USB Power Supply](https://www.raspberrypi.com/products/micro-usb-power-supply/) | [Type C Power Supply](https://www.raspberrypi.com/products/type-c-power-supply/)         | [27W Power Supply](https://www.raspberrypi.com/products/27w-power-supply/)       |
| 16GB or bigger Class 10 SD Card | [SD Cards](https://www.raspberrypi.com/products/sd-cards/)                             | [SD Cards](https://www.raspberrypi.com/products/sd-cards/)                               | [SD Cards](https://www.raspberrypi.com/products/sd-cards/)                       |
...
Click **App Options** in the bottom left corner of Raspberry Pi Imager.
...
Choose **MonsterPi** from the OS list.
