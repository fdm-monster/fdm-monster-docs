...
Older MonsterPi's used a different setup and an unstable update script.
...
### Older MonsterPi versions to 0.1.0-0.3.2

:::warning
There is no upgrade path to MonsterPi 0.4. Only by downloading the new image, users will be able to use FDM Monster 2+.
:::
