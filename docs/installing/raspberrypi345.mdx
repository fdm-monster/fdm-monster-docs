...
:::warning
Note: User's have reported problems changing the username other than `pi`. Please check [this issue](https://github.com/fdm-monster/MonsterPi/issues/132) if you want to see the status of this problem.
...
### Solution: Configure Custom Content Repository

Follow these steps to enable MonsterPi customization options:

### 1. Open App Options

Click **App Options** in the bottom right corner of Raspberry Pi Imager.

<img width="183" height="58" alt="App Options button" src="https://github.com/user-attachments/assets/fcdfe8f6-5501-49f9-8a90-046b38abc657" />

### 2. Edit Content Repository

Click **EDIT** next to "Content Repository".

<img width="398" height="54" alt="Content Repository edit button" src="https://github.com/user-attachments/assets/8114b9d1-e2e0-47c0-be6e-2a286da0cf9a" />

### 3. Add Custom URL

Select **Use Custom URL** and paste the MonsterPi JSON URL.

> **Find the JSON URL:** Go to the [latest MonsterPi release](https://github.com/fdm-monster/MonsterPi/releases/latest) and copy the URL from the "Raspberry Pi Imager v2 - Custom OS" section in the release notes.
...
<img width="659" height="470" alt="Raspberry Pi Imager with customization options enabled" src="https://github.com/user-attachments/assets/eebb172a-da01-4b82-ab82-03514b04d2e2" />
...
<img width="675" height="474" alt="Raspberry Pi Imager without customization options" src="https://github.com/user-attachments/assets/26cafba6-825f-478b-bb54-2c1b500feb63" />

**Solution:** Follow the steps above to configure the custom content repository.

#### Alternative: Download Custom JSON File

Instead of using a URL, you can download the JSON file from the [latest release](https://github.com/fdm-monster/MonsterPi/releases/latest) and use the **Use Custom File** option in the Content Repository settings.
