...
If you haven't set up the FDM Monster server yet, please refer to the **[Server Setup](./setup_server.mdx)** guide.
:::
...
- [FDM Monster Server](./setup_server.mdx)
...
To set up a Virtual printer follow the [OctoPrint Setup](./setup_octoprint.mdx) documentation.
