...
1. The Swagger UI will use your active session
1. Alternatively, use API keys for programmatic access
...
1. Find the endpoint you want to test (e.g., `GET /api/v2/printer`)
