...
1. Navigate to your user settings or API keys section
1. Fill in a name for the new API key (e.g., "My Integration Script")
1. Click "Create"
1. Copy the generated key immediately - it will only be shown once
